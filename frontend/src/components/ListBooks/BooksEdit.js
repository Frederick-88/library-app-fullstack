...
const EditBookForm = (props) => {
  ...
  // TANPA FITUR USE EFFECT, NANTI BOOK TITLE DLL BAKAL KOSONG PAS INPUT ITU, DGN USEEFFECT BAKAL MNCUL DATA DI INPUT CARD TSB.
  // BTW DGN USE EFFECT INI DATA DIUBAH MENJADI DATA BARU YANG BISA DIGUNAKAN DLAM REDUCER LALU BISA DIGUNAKAN ACTION. NENGOK LA PERUBAHANNYA.
  useEffect(()=>{
